    ...
    <div class="container">
      <div class="row px-md-3">
        ...
        <div class="col-sm-6 col-lg-3 py-3">
          <h5>Our partner</h5>
          <ul class="footer-menu">
            <li><a href="#">Grand Hantha</a></li>

          </ul>
        </div>
        <div class="col-sm-6 col-lg-3 py-3">
          <h5>Contact</h5>
          <p class="footer-link mt-2">No.660 , Marchart Street , Pyay , Myanmar</p>
          <a href="#" class="footer-link">09 666880666</a>
          <a href="#" class="footer-link">pyimyanmar@gmail.com</a>
